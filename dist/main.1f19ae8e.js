...
var html = document.querySelector("#html"); // 从html里获取id=html的元素
...
var step = function step() {
  setTimeout(function () {
    ...
    html.innerHTML = string2; // demo.innerHTML = string.substring(0, n);
    // innerHTML会覆盖原有的html里的内容。substring表示返回字符串对象中指定位置的子字符串

    style.innerHTML = string.substring(0, n); // 这行代码是为了把color的样式应用到html里。
